...
def build_signal(symbol: str, timeframe: str,
    ...
    return Signal(
        ...
        scale_action=(sel.scale_action if hasattr(sel, 'scale_action') else (scale.action if scale else "HOLD")),
        scale_mult=(sel.scale_mult if hasattr(sel, 'scale_mult') else (scale.size_multiplier if scale else 1.0)),
